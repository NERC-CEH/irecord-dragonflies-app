		...
		copy: {
		  main: {
		    files: [
		      ...
		      {src: ['src/lib/photoswipe/photoswipe.css'], dest: '../../styles/photoswipe.css'},
				{src: ['src/lib/photoswipe/icons.png'], dest: '../../styles/icons.png'},
				{src: ['src/lib/photoswipe/icons@2x.png'], dest: '../../styles/icons@2x.png'}
			]
		  }
		},
		concat: {
